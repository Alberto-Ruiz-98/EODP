...
for band in bands:
    ...
    Number_Saturated_Pixels = np.sum(Alberto_toa == 4095)
    Error_saturated = Number_Saturated_Pixels * 100 / Alberto_toa.size
    print("The percentage of saturated pixels for", ism_toa_ + band,"is", "{:.2f}".format(Error_saturated), "%.")
